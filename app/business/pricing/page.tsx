          ...
          <div className="max-w-4xl mx-auto px-4 py-8 pb-[calc(3rem+env(safe-area-inset-bottom))] space-y-12">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors ${annual ? "bg-orange-500" : "bg-gray-700"}`}
              >
                <span
                  className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-white transition-transform ${annual ? "translate-x-6" : "translate-x-0"}`}
                />
              </button>
            ...
            <section className="space-y-4">
              ...
              <div className="grid md:grid-cols-3 gap-5">
                {[
                  ...
                  <div
                    key={pkg.title}
                    className={`bg-gray-900 rounded-2xl p-5 space-y-3 ${pkg.highlight ? "border border-orange-500/30" : "border border-white/10"}`}
                  >
                ...
                {FAQS.map((faq, i) => (
                  <div key={i} className="bg-gray-900 border border-white/10 rounded-2xl overflow-hidden">
                    ...
                    >
                      ...
                      <span className="text-gray-500 ml-4 flex-shrink-0">{openFaq === i ? "−" : "+"}</span>
                    </button>
                    {openFaq === i && (

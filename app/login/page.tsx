  ...
  return (
    <div className="bg-[#0a0a0f] min-h-screen flex items-center justify-center px-4">
      <div className="bg-gray-900 border border-white/10 rounded-2xl p-8 w-full max-w-sm">
        ...
        <p className="text-gray-400 text-sm mb-6">Sign in to your FanRush account</p>
        ...
        <div className="space-y-3">
          <button
            disabled
            title="Coming soon"
            className="w-full flex items-center justify-center gap-2 bg-transparent border border-white/10 rounded-xl px-4 py-2.5 text-gray-600 text-sm font-medium cursor-not-allowed"
          >
            ...
            <span className="ml-auto text-gray-700 text-xs">Coming soon</span>
          </button>
          <button
            disabled
            title="Coming soon"
